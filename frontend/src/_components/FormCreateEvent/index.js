...
class FormCreateEvent extends Component {
    ...
    handleSubmit(e) {
        ...
        const { event } = this.state
        if (event.eventName && event.location && event.startDate && event.endDate && event.desc && event.pic) {
            ...
            <div className="centrar">
                <div className="col-md-6 col-md-offset-3">
                    ...
                    <form name="form" onSubmit={this.handleSubmit}>
                        <div
                         className={
                            'form-group' + (submitted && !event.eventName ? ' has-error' : '')
                          }
                        >
                        ...
                        <div
                        className={
                        'form-group' + (submitted && !event.location ? ' has-error' : '')
                        }
                        >
                        ...
                        <div
                        className={
                            'form-group' + (submitted && !event.startDate ? ' has-error' : '')
                        }
                        >
                        ...
                        <div
                        className={
                            'form-group' + (submitted && !event.endtDate ? ' has-error' : '')
                        }
                        >
